...
export default function Home() {
  return (
    <main className="flex flex-row content-center items-center h-full w-full ">
      {/* <div className="w-1/3 flex place-content-center"></div> */}
      <div className="flex flex-col items-center content-center w-full">
        <div className="flex place-content-center">
          <Image
            alt="profile photo"
            className="rounded-full min-h-260 pr-5"
            style={{
              minWidth: "371px",
              maxWidth: "371px",
              minHeight: "395px",
        ...
        platform.`}</p>
            <p className="mt-5">{`In my spare time, I enjoy sci fi, gardening, playing with my devilish cat, and hiking with my wife. If you are looking for someone to take on a development project or want to connect, send me a message.`}</p>
          </div>
